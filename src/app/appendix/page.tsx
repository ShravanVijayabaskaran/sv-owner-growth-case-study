...
import { Stack, SectionHeading, Eyebrow, H1 } from "@/components/ui";
    ...
    <Stack gap={28}>
      ...
      <Stack gap={12}>
        {files.map((f) => {
          ...
          return <SqlBlock key={f.name} name={f.name} title={meta.title} page={meta.page} blurb={meta.blurb} code={f.code} />;
        })}
      </Stack>
    </Stack>
  );
