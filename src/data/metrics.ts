...
export const KPIS: { name: string; category: KpiCategory; definition: string; why: string; used: string }[] = [
  { name: "Per-Location GMV Growth", category: "North Star", definition: "Geometric mean of a location's GMV growth over its own lifeycle/tenure. \n\nWe're using a geometric mean as its a more accurate measure of steady compound growth than a traditional arithmetic mean. \n\n Example: \n Y0 = $100\nY1 = $150 (+50%)\nY2 = $75 (-50%)\n\nArithmetic Mean = 0% (Inaccurate)\nGeometric Mean = -13.4% (Accurate)", why: "Isolates whether the product is driving a real sustained growth over a given time horizon with each location as its own control.", used: "Growth" },
  { name: "Guest Re-Order Rate", category: "Primary", definition: "Percent share of guests with a repeat order with the same brand within a fixed window.", why: "Building repeat order behavior is a core goal of the Owner platform to drive long term revenue.", used: "Growth · App" },
