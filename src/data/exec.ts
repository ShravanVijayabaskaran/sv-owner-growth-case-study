...
export const EXEC_FINDINGS: { q: string; verdict: string; body: string; tone: "success" | "info" }[] = [
  ...
  },
  {
    ...
    verdict: "Guests Experience a +26% GMV Lift in the 180D Following App Adoption",
...
export const EXEC_CAVEATS = [
  ...
  "A guest's 'first order' may not be their true first order due to a lack of continuous data.",
];
